...
class CeilingFanBookingScreen extends StatefulWidget {
  final Map<String, dynamic> item;

  const CeilingFanBookingScreen({super.key, required this.item});

  @override
  State<CeilingFanBookingScreen> createState() =>
      _CeilingFanBookingScreenState();
}

class _CeilingFanBookingScreenState extends State<CeilingFanBookingScreen> {
  // COLORS
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _title("How many fans?"),
            _fanCountSelector(),
            const SizedBox(height: 25),
            _title("Type of Installation"),
            ...
            const SizedBox(height: 25),
            _title("Electrical Box"),
            _singleChipSelector(
                boxTypes, selectedBox, (v) => setState(() => selectedBox = v)),
            const SizedBox(height: 25),
    ...
    return _card(
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            const Text("Ceiling Fans", style: TextStyle(fontSize: 17)),
            Row(
              children: [
                _circleBtn(Icons.remove, () {
                  if (fanCount > 1) setState(() => fanCount--);
                }),
                Padding(
                ...
                _circleBtn(Icons.add, () => setState(() => fanCount++)),
              ],
            ),
          ],
        ),
  ...
  Widget _estimatedPrice() {
    return Container(
      ...
      child: const Text(
        "Estimated Price: \$80 – \$180\n(Height, wiring & fan type may affect price)",
