...
class SmartACControllerBookingScreen extends StatefulWidget {
  final Map<String, dynamic> item;

  const SmartACControllerBookingScreen({
    super.key,
    required this.item,
  });

  @override
  State<SmartACControllerBookingScreen> createState() =>
      _SmartACControllerBookingScreenState();
}

class _SmartACControllerBookingScreenState
    extends State<SmartACControllerBookingScreen> {
  // COLORS
  ...
  // OPTIONS
  String acType = "Window AC";
  String controllerBrand = "Sensibo";
  ...
  final List<String> acTypes = [
    ...
    "Portable AC",
    "Mini-Split AC",
    "Central AC (thermostat connected)",
  ];
  ...
  final List<String> extras = [
    ...
    "Connect to WiFi",
    "Set up temperature automation",
    "App setup for iPhone/Android",
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _title("AC Type"),
            _chips(acTypes, acType, (v) => setState(() => acType = v)),
            const SizedBox(height: 22),
    ...
    return _card(
      child: Padding(
        ...
        child: Text(
          ...
          "You will receive updates as soon as someone accepts your request.",
