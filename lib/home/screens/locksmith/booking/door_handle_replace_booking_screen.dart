...
class DoorHandleReplaceBookingScreen extends StatefulWidget {
  final Map<String, dynamic> item;

  const DoorHandleReplaceBookingScreen({super.key, required this.item});

  @override
  State<DoorHandleReplaceBookingScreen> createState() =>
      _DoorHandleReplaceBookingScreenState();
}

class _DoorHandleReplaceBookingScreenState
    extends State<DoorHandleReplaceBookingScreen> {
            ...
            child:
              ...
              _card(
                Row(
                    ...
                    children: [
                      const Text("Handles", style: TextStyle(fontSize: 16)),
                      Row(children: [
                        _circleBtn(Icons.remove, () {
                          if (handles > 1) setState(() => handles--);
                        }),
                        Padding(
    ...
    return InkWell(
        ...
        child: Container(
            ...
            decoration: const BoxDecoration(
                color: Color(0xFF2B6E4F), shape: BoxShape.circle),
